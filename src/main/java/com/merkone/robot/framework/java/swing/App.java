package com.merkone.robot.framework.java.swing;
 ...
 *
 * @see
 * <a href="https://github.com/robotframework/SwingLibrary">SwingLibrary</a>
 *
 * @author vescudero
 */
public class App {
    ...
    private final boolean introduceBugs;
    private final List<String> todoItems = new ArrayList<>();

    public App(boolean introduceBugs) {
